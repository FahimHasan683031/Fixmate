...
// Controller to get the number of unread notifications
...
// Controller to send a test push notification for debugging
const sendTestPushNotification = catchAsync(async (req: Request, res: Response) => {
  const { token, title, body } = req.body;

  const result = await PushNotificationService.sendPushNotification(
    token ||
    'c0UaCLXGSJ6JsC62K6NPq0:APA91bHzTTe3umtCk7TzNcOXN-aa3SPNQVOtgx6jwQvz1OiTDKLJEIPc-A-8Wn707pYzKnwDZA1nH2zDNvkxTPbpB7SUMAYO3odSW8PEFzCopYf930fNLHE',
